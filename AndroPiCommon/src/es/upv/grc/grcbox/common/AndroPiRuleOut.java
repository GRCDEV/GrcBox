...
public class AndroPiRuleOut extends AndroPiRule {
	public AndroPiRuleOut() {
		super();
		this.incomming = true;
	}
	 ...
	 */
	public AndroPiRuleOut(int id, Protocol proto, int appid,
	...
	public AndroPiRuleOut(AndroPiRule rule){
